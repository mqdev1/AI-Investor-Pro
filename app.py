...
# زر واتساب
whatsapp_url = "https://wa.me/970567256989" # استبدل YOUR_NUMBER برقمك
...
st.sidebar.code("mahdevproo@gmail.com")
...
# --- 5. خارطة الطريق (Roadmap) - لجذب المستثمرين ---
st.markdown("---")
st.subheader("🚀 خارطة طريق تطوير المشروع (Roadmap)")
r_col1, r_col2, r_col3 = st.columns(3)

r_col1.info("📌 **المرحلة الحالية**\n* تحليل الأسهم والعملات\n* مؤشرات RSI اللحظية\n* واجهة ويب تفاعلية")
r_col2.warning("🛠 **قريباً (النسخة الاحترافية)**\n* تحليل الأخبار عبر ChatGPT\n* تنبيهات واتساب فورية\n* إضافة الأسواق المحلية")
r_col3.success("💰 **المستقبل (التداول الآلي)**\n* ربط المحافظ المالية\n* تداول آلي عبر الـ AI\n* إدارة الأصول الكبرى")
